...
import { getSessionUser, sessionCookie, isAdminEmail, json } from '../../lib/auth.js'
...
export async function onRequest(context) {
  ...
  try {
    ...
    return json({ ok: true, email: sess.user.email, userId: sess.user.id, isAdmin: isAdminEmail(env, sess.user.email) }, { headers })
  } catch (e) {
